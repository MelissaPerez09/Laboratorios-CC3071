...
def generate_source_code(yalex_path, output_path):
    ...
    with open(output_path, 'w') as f:
        ...
        f.write("def analizar_archivo(afnd_transitions, afnd_start_state, token_actions, texto_entrada):\n")
        ...
        f.write("                       break\n")
        f.write("           if not match_found:\n")
        f.write("               errores.append((i+1, j+1, token))\n")
        f.write("   acciones_ejecutadas = 0\n")
        f.write("   for i, token in enumerate(tokens):\n")
        f.write("       exec(token)\n")
        f.write("       acciones_ejecutadas += 1\n")
        f.write("   for error in errores:\n")
        f.write("       print(f'Error en la linea {error[0]}, posición {error[1]}: {error[2]}')\n")
        f.write("   print('\\n>> finished execution\\n')\n")
        f.write("   return tokens, errores\n")
