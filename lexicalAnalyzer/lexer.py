...
with open('./lexicalAnalyzer/LexicalAnalyzer.py', 'w') as f:
    ...
    f.write("           graph.node(str(state), f'{str(state)}{token_action}', shape='doublecircle')\n")
    f.write("       else:\n")
    ...
    f.write("       graph.node(str(accept_state), f'{str(accept_state)}{token_action}', shape='doublecircle')\n")
